...
class JobSourcesAggregator:
    ...
    def fetch_hackernews_hiring(self) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            offers = []
            # Traiter les commentaires du thread
            for comment_id in story_data["kids"][:45]:
        ...
        labs_data = [
            {
                ...
                "applyUrl": "https://www.cst.cam.ac.uk/research",
            ...
            },
            {
                ...
                "applyUrl": "https://ori.ox.ac.uk/vacancies/",
            ...
            },
            {
                ...
                "applyUrl": "https://www.imperial.ac.uk/hamlyn-centre/",
            ...
            },
            {
                ...
                "applyUrl": "https://www.tudelft.nl/en/3me/about/departments/delft-center-for-systems-and-control-dcsc",
            ...
            },
            {
                ...
                "applyUrl": "https://www.epfl.ch/labs/esl/",
            ...
            },
            {
                ...
                "applyUrl": "https://www.cs.cit.tum.de/en/air/home/",
            ...
            },
            {
                ...
                "applyUrl": "https://www.titech.ac.jp/english/",
            ...
            },
            {
                ...
                "applyUrl": "https://www.utias-sfl.net/",
    ...
    def fetch_all(self) -> List[Dict[str, Any]]:
        """Exécute la collecte complète sur l'ensemble des 8 sources mondiales configurées."""
        all_offers = []
